...
namespace HGUniversal.Controls
{
    public partial class ModuleControls : UserControl
    {
        ...
        private void _submitcommanddelay_Tick(object sender, object e)
        {
            _submitcommanddelay.Stop();
        ...
        {
            DataContext = module;
            var cc = new HsbColorConverter();
            var lightcolor = (Color)cc.Convert(module.Properties, null, "Status.ColorHsb", 
